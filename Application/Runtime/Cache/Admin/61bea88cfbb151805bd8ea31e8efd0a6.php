                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t " method="post" action="<?php echo U('add');?>">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="high_id" id="high_id">
                                    ...
                                    <?php if(is_array($high_level)): foreach($high_level as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"
                                        <?php if(($vo["id"] == $data['high_id'])): ?>selected<?php endif; ?>
                                        ><?php echo ($vo["high_name"]); ?></option><?php endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="name" class="form-control" name="middle_name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" value="0" name="is_recommend"
