                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <ol class="breadcrumb">
                                <li>
                                    <strong><a href="<?php echo U('lists');?>"
                                        <?php if(($_GET['type'] == 0)): ?>style="color: #1ab394"<?php endif; ?>
                                        >热门网址</a></strong>
                                </li>
                                <li>
                                    <strong><a href="<?php echo U('lists',array('type'=>1));?>"
                                        <?php if(($_GET['type'] == 1)): ?>style="color: #1ab394"<?php endif; ?>
                                        >广告区</a></strong>
                                </li>
                                <li>
                                    <strong><a href="<?php echo U('lists',array('type'=>2));?>"
                                        <?php if(($_GET['type'] == 2)): ?>style="color: #1ab394"<?php endif; ?>
                                        >图片区</a></strong>
                                </li>
                            </ol>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table  table-bordered table-hover">
                                        ...
                                        <?php if(is_array($hot)): foreach($hot as $key=>$vo): ?><tr>
                                                <td>
                                                    <input class="ids regular-checkbox" type="checkbox" value="<?php echo ($vo["id"]); ?>"
                                                           name="ids[]" id="check_<?php echo ($vo["entity_id"]); ?>">
                                                    <label for="check_<?php echo ($vo["entity_id"]); ?>"></label>
                                                </td>
                                                <?php if(($_GET['type'] == 2)): ?><td><img height="40px" width="80px"
                                                             src="<?php echo (get_cover_url($vo["picture"])); ?>"/></td><?php endif; ?>
                                                <td> <?php echo ($vo["id"]); ?></td>
                                                <td> <?php echo ($vo["title"]); ?></td>
                                                <td> <?php echo ($vo["href"]); ?></td>
                                                <td>
                                                    <?php if(($vo["is_recommend"]) == "1"): ?>是
                                                        <?php else: ?>
                                                        否<?php endif; ?>
                                                </td>
