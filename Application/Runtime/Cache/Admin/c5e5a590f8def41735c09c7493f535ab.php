                    ...
                    <form class="form-horizontal m-t " method="post" action="<?php echo U('add');?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select name="layout">
                                    <option value="left"
                                    <?php if(($data["layout"] == 'left')): ?>selected<?php endif; ?>
                                    >左侧</option>
                                    <option value="bottom"
                                    <?php if(($data["layout"] == 'bottom')): ?>selected<?php endif; ?>
                                    >底部</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="high_name" class="form-control" name="high_name"
                                       value="<?php echo ($data["high_name"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
