...
<head>
    ...
    <link rel="stylesheet" href="/APP/Public/css/admin-style.css?v=2.2.0">
...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div>
        ...
        <form id="form" name="form" method="post" action="<?php echo U('Public/checkLogin');?>" autocomplete="off">
            ...
            <div class="form-group login">
                ...
                <a> <img class="reloadverify" src="<?php echo U('Admin/Public/verify');?>" id="imgcode"
